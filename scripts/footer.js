...
var content_footer = '' +
	...
	'<div id="publications" class="vertical section">' +
		...
		'<a href="#" class="title">notre page mastodon</a>' +
	'</div>' +
	'<div id="participer" class="vertical section">' +
		'<h1 class="title">participer a notre travail</h1>' +
		'<a href="#" class="title">la discussion telegram</a>' +
		'<a href="#" class="title">le groupe de travail discord</a>' +
	'</div>' +
	'<div id="apropos" class="vertical section">' +
